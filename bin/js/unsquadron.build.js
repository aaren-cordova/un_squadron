...
/*** @define {boolean} goog.EXPORT_API */
goog.EXPORT_API = false;
...
goog.inherits = function(childCtor, parentCtor) {
  //goog.global.console.log(childCtor, parentCtor);
...
goog.scope(function(){
	...
	*/
	...
	greensock.Linear.easeOut = GreenSockGlobals['Linear']['easeOut'];
	...
	* @param {!Object} vars
	*/
	greensock.TweenMax = GreenSockGlobals['TweenMax'];
	...
	*/
	...
	/*
	goog.exportSymbol('greensock.Ease', greensock.Ease);
	goog.exportSymbol('greensock.Power4', greensock.Power4);
	goog.exportSymbol('greensock.Strong', greensock.Strong);
	goog.exportSymbol('greensock.Quint', greensock.Quint);
	goog.exportSymbol('greensock.Power3', greensock.Power3);
	goog.exportSymbol('greensock.Quart', greensock.Quart);
	goog.exportSymbol('greensock.Power2', greensock.Power2);
	goog.exportSymbol('greensock.Cubic', greensock.Cubic);
	goog.exportSymbol('greensock.Power1', greensock.Power1);
	goog.exportSymbol('greensock.Quad', greensock.Quad);
	goog.exportSymbol('greensock.Power0', greensock.Power0);
	goog.exportSymbol('greensock.Linear', greensock.Linear);
	goog.exportSymbol('greensock.TweenLite', greensock.TweenLite);
	goog.exportSymbol('greensock.TweenPlugin', greensock.TweenPlugin);
	goog.exportSymbol('greensock.TweenMax', greensock.TweenMax);
	goog.exportSymbol('greensock.TimelineLite', greensock.TimelineLite);
	goog.exportSymbol('greensock.TimelineMax', greensock.TimelineMax);
	goog.exportSymbol('greensock.BezierPlugin', greensock.BezierPlugin);
	goog.exportSymbol('greensock.CSSPlugin', greensock.CSSPlugin);
	goog.exportSymbol('greensock.BackOut', greensock.BackOut);
	goog.exportSymbol('greensock.BackIn', greensock.BackIn);
	goog.exportSymbol('greensock.BackInOut', greensock.BackInOut);
	goog.exportSymbol('greensock.Back', greensock.Back);
	goog.exportSymbol('greensock.SlowMo', greensock.SlowMo);
	goog.exportSymbol('greensock.SteppedEase', greensock.SteppedEase);
	goog.exportSymbol('greensock.RoughEase', greensock.RoughEase);
	goog.exportSymbol('greensock.BounceOut', greensock.BounceOut);
	goog.exportSymbol('greensock.BounceIn', greensock.BounceIn);
	goog.exportSymbol('greensock.BounceInOut', greensock.BounceInOut);
	goog.exportSymbol('greensock.Bounce', greensock.Bounce);
	goog.exportSymbol('greensock.CircOut', greensock.CircOut);
	goog.exportSymbol('greensock.CircIn', greensock.CircIn);
	goog.exportSymbol('greensock.CircInOut', greensock.CircInOut);
	goog.exportSymbol('greensock.Circ', greensock.Circ);
	goog.exportSymbol('greensock.ElasticOut', greensock.ElasticOut);
	goog.exportSymbol('greensock.ElasticIn', greensock.ElasticIn);
	goog.exportSymbol('greensock.ElasticInOut', greensock.ElasticInOut);
	goog.exportSymbol('greensock.Elastic', greensock.Elastic);
	goog.exportSymbol('greensock.ExpoOut', greensock.ExpoOut);
	goog.exportSymbol('greensock.ExpoIn', greensock.ExpoIn);
	goog.exportSymbol('greensock.ExpoInOut', greensock.ExpoInOut);
	goog.exportSymbol('greensock.Expo', greensock.Expo);
	goog.exportSymbol('greensock.SineOut', greensock.SineOut);
	goog.exportSymbol('greensock.SineIn', greensock.SineIn);
	goog.exportSymbol('greensock.SineInOut', greensock.SineInOut);
	goog.exportSymbol('greensock.Sine', greensock.Sine);
	goog.exportSymbol('greensock.EaseLookup', greensock.EaseLookup);
	*/
