...
(function(){
	...
	/*
	var GreenSockGlobals = window.GreenSockGlobals.noConflict();
	function export_(obj){
		for(var key in obj){
			if(obj.hasOwnProperty(key)){
				if(key !== 'com' && key !== 'noConflict'){
					//goog.provide('greensock.' + key);
					greensock[key] = obj[key];
				}
			}
