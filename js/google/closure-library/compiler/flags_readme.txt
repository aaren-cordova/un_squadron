...
C:\Users\aaren.cordova\Documents\SVN\un_squadron\trunk\js\closure-library\compil
er>java -jar compiler.jar --help
 ...
 --jscomp_error VAL                     : Make the named class of warnings an
                                          ...
                                          ties, nonStandardJsDocs, reportUnknown

                                          Types, suspiciousCode, strictModuleDep

                                          Check, typeInvalidation, undefinedName

                                          s, undefinedVars, unknownDefines,
 ...
 --jscomp_off VAL                       : Turn off the named class of warnings.
                                          ...
                                          erties, nonStandardJsDocs, reportUnkno

                                          wnTypes, suspiciousCode, strictModuleD

                                          epCheck, typeInvalidation, undefinedNa

                                          mes, undefinedVars, unknownDefines,
                                          uselessCode, visibility
