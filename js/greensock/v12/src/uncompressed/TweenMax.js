 ...
 */
	window._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin","TweenLite"], function(TweenPlugin, TweenLite) {
		...
		var _hasPriority, //turns true whenever a CSSPropTween instance is created that has a priority other than 0. This helps us discern whether or not we should spend the time organizing the linked list or not after a CSSPlugin's _onInitTween() method is called.
		 ...
		 * @return {Object} returns itself so that multiple methods can be chained together.
		 */
		 ...
		 * @param {Object} vars containing the end values, like {className:"newClass", ease:Linear.easeNone}
